...
class account_statistics_plugin : public contento::app::plugin
{
   public:
...
FC_REFLECT( contento::account_statistics::account_stats_bucket_object,
   (id)
   (open)
   (seconds)
   (name)
...
//SET_INDEX_TYPE( contento::account_statistics::account_stats_bucket_object,)

FC_REFLECT(
   contento::account_statistics::account_activity_bucket_object,
   (id)
   (open)
   (seconds)
