...
class debug_node_plugin : public contento::app::plugin
{
   public:
      ...
      void debug_update( Lambda&& callback, uint32_t skip = contento::chain::database::skip_nothing )
      {
      ...
      uint32_t debug_generate_blocks(
         ...
         uint32_t count,
         uint32_t skip = contento::chain::database::skip_nothing,
