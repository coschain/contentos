...
)
{
   ...
   contento::chain::public_key_type debug_public_key;
   if( debug_key != "" )
   {
   ...
   contento::chain::database& db = database();
   ...
   while( produced < count )
   {
      ...
      contento::chain::public_key_type scheduled_key = scheduled_witness.signing_key;
      if( debug_key != "" )
      {
