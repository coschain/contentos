...
{
   public:
      raw_block_api_impl( contento::app::application& _app );

      std::shared_ptr< contento::plugin::raw_block::raw_block_plugin > get_plugin();

      contento::app::application& app;
};

raw_block_api_impl::raw_block_api_impl( contento::app::application& _app ) : app( _app )
{}

std::shared_ptr< contento::plugin::raw_block::raw_block_plugin > raw_block_api_impl::get_plugin()
{
...
raw_block_api::raw_block_api( const contento::app::api_context& ctx )
{
