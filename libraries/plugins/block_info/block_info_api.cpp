...
{
   public:
      block_info_api_impl( contento::app::application& _app );

      std::shared_ptr< contento::plugin::block_info::block_info_plugin > get_plugin();
...
block_info_api_impl::block_info_api_impl( contento::app::application& _app ) : app( _app )
{}

std::shared_ptr< contento::plugin::block_info::block_info_plugin > block_info_api_impl::get_plugin()
{
...
block_info_api::block_info_api( const contento::app::api_context& ctx )
{
