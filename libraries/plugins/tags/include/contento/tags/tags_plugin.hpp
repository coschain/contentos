...
class tag_stats_object : public object< tag_stats_object_type, tag_stats_object >
{
   public:
      ...
      tag_name_type     tag;
      asset             total_payout = asset( 0, VESTS_SYMBOL );
      int32_t           net_votes = 0;
...
class author_tag_stats_object : public object< author_tag_stats_object_type, author_tag_stats_object >
{
  public:
      ...
      account_id_type author;
      tag_name_type   tag;
      asset           total_rewards = asset( 0, VESTS_SYMBOL );
 ...
 *
 */
class tags_plugin : public contento::app::plugin
{
   public:
...
FC_API( contento::tags::tag_api, (get_tags) );

FC_REFLECT( contento::tags::tag_object,
   (id)(tag)(created)(active)(cashout)(net_rshares)(net_votes)(hot)(trending)(promoted_balance)(children)(author)(parent)(comment) )
CHAINBASE_SET_INDEX_TYPE( contento::tags::tag_object, contento::tags::tag_index )

FC_REFLECT( contento::tags::tag_stats_object,
   (id)(tag)(total_payout)(net_votes)(top_posts)(comments)(total_trending) );
CHAINBASE_SET_INDEX_TYPE( contento::tags::tag_stats_object, contento::tags::tag_stats_index )

FC_REFLECT( contento::tags::peer_stats_object,
   (id)(voter)(peer)(direct_positive_votes)(direct_votes)(indirect_positive_votes)(indirect_votes)(rank) );
CHAINBASE_SET_INDEX_TYPE( contento::tags::peer_stats_object, contento::tags::peer_stats_index )

FC_REFLECT( contento::tags::comment_metadata, (tags) );

FC_REFLECT( contento::tags::author_tag_stats_object, (id)(author)(tag)(total_posts)(total_rewards) )
CHAINBASE_SET_INDEX_TYPE( contento::tags::author_tag_stats_object, contento::tags::author_tag_stats_index )
