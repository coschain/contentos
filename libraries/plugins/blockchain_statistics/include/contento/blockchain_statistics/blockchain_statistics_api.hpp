...
{
   public:
      blockchain_statistics_api( const contento::app::api_context& ctx );
...
FC_REFLECT( contento::blockchain_statistics::statistics,
   (blocks)
   (bandwidth)
   (operations)
   (transactions)
...
FC_API( contento::blockchain_statistics::blockchain_statistics_api,
   (get_stats_for_time)
