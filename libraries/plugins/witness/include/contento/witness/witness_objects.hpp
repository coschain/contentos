...
class reserve_ratio_object : public object< reserve_ratio_object_type, reserve_ratio_object >
{
   public:
       ...
       *   reaches CONTENTO_MAX_RESERVE_RATIO.  Any time average_block_size is greater than
       ...
       *
       *    max_bandwidth = maximum_block_size * CONTENTO_BANDWIDTH_AVERAGE_WINDOW_SECONDS / CONTENTO_BLOCK_INTERVAL
       *
