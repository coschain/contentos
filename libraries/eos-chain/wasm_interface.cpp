...
REGISTER_INTRINSICS_WITH_PRICE(context_free_system_api,
   ...
   WITH_PRICE (eosio_assert,         void(int, int)      )
   WITH_PRICE (eosio_assert_message, void(int, int, int) )
   WITH_PRICE (eosio_assert_code,    void(int, int64_t)  )
   WITH_PRICE (eosio_exit,           void(int)           )
);
...
REGISTER_INTRINSICS_WITH_PRICE(authorization_api,
   ...
   ((require_authorization, void(int64_t), "require_auth", void(authorization_api::*)(const account_name&) ), ::eosio::chain::wasm_price::require_auth )
   ((require_authorization, void(int64_t, int64_t), "require_auth2", void(authorization_api::*)(const account_name&, const permission_name& permission) ), ::eosio::chain::wasm_price::require_auth2 )
   ((has_authorization,     int(int64_t), "has_auth", bool(authorization_api::*)(const account_name&)const ), ::eosio::chain::wasm_price::has_auth )
...
REGISTER_INJECTED_INTRINSICS_WITH_PRICE(softfloat_api,
      WITH_PRICE (_eosio_f32_add,       float(float, float)    )
      WITH_PRICE (_eosio_f32_sub,       float(float, float)    )
      WITH_PRICE (_eosio_f32_mul,       float(float, float)    )
      WITH_PRICE (_eosio_f32_div,       float(float, float)    )
      WITH_PRICE (_eosio_f32_min,       float(float, float)    )
      WITH_PRICE (_eosio_f32_max,       float(float, float)    )
      WITH_PRICE (_eosio_f32_copysign,  float(float, float)    )
      WITH_PRICE (_eosio_f32_abs,       float(float)           )
      WITH_PRICE (_eosio_f32_neg,       float(float)           )
      WITH_PRICE (_eosio_f32_sqrt,      float(float)           )
      WITH_PRICE (_eosio_f32_ceil,      float(float)           )
      WITH_PRICE (_eosio_f32_floor,     float(float)           )
      WITH_PRICE (_eosio_f32_trunc,     float(float)           )
      WITH_PRICE (_eosio_f32_nearest,   float(float)           )
      WITH_PRICE (_eosio_f32_eq,        int(float, float)      )
      WITH_PRICE (_eosio_f32_ne,        int(float, float)      )
      WITH_PRICE (_eosio_f32_lt,        int(float, float)      )
      WITH_PRICE (_eosio_f32_le,        int(float, float)      )
      WITH_PRICE (_eosio_f32_gt,        int(float, float)      )
      WITH_PRICE (_eosio_f32_ge,        int(float, float)      )
      WITH_PRICE (_eosio_f64_add,       double(double, double) )
      WITH_PRICE (_eosio_f64_sub,       double(double, double) )
      WITH_PRICE (_eosio_f64_mul,       double(double, double) )
      WITH_PRICE (_eosio_f64_div,       double(double, double) )
      WITH_PRICE (_eosio_f64_min,       double(double, double) )
      WITH_PRICE (_eosio_f64_max,       double(double, double) )
      WITH_PRICE (_eosio_f64_copysign,  double(double, double) )
      WITH_PRICE (_eosio_f64_abs,       double(double)         )
      WITH_PRICE (_eosio_f64_neg,       double(double)         )
      WITH_PRICE (_eosio_f64_sqrt,      double(double)         )
      WITH_PRICE (_eosio_f64_ceil,      double(double)         )
      WITH_PRICE (_eosio_f64_floor,     double(double)         )
      WITH_PRICE (_eosio_f64_trunc,     double(double)         )
      WITH_PRICE (_eosio_f64_nearest,   double(double)         )
      WITH_PRICE (_eosio_f64_eq,        int(double, double)    )
      WITH_PRICE (_eosio_f64_ne,        int(double, double)    )
      WITH_PRICE (_eosio_f64_lt,        int(double, double)    )
      WITH_PRICE (_eosio_f64_le,        int(double, double)    )
      WITH_PRICE (_eosio_f64_gt,        int(double, double)    )
      WITH_PRICE (_eosio_f64_ge,        int(double, double)    )
      WITH_PRICE (_eosio_f32_promote,    double(float)         )
      WITH_PRICE (_eosio_f64_demote,     float(double)         )
      WITH_PRICE (_eosio_f32_trunc_i32s, int(float)            )
      WITH_PRICE (_eosio_f64_trunc_i32s, int(double)           )
      WITH_PRICE (_eosio_f32_trunc_i32u, int(float)            )
      WITH_PRICE (_eosio_f64_trunc_i32u, int(double)           )
      WITH_PRICE (_eosio_f32_trunc_i64s, int64_t(float)        )
      WITH_PRICE (_eosio_f64_trunc_i64s, int64_t(double)       )
      WITH_PRICE (_eosio_f32_trunc_i64u, int64_t(float)        )
      WITH_PRICE (_eosio_f64_trunc_i64u, int64_t(double)       )
      WITH_PRICE (_eosio_i32_to_f32,     float(int32_t)        )
      WITH_PRICE (_eosio_i64_to_f32,     float(int64_t)        )
      WITH_PRICE (_eosio_ui32_to_f32,    float(int32_t)        )
      WITH_PRICE (_eosio_ui64_to_f32,    float(int64_t)        )
      WITH_PRICE (_eosio_i32_to_f64,     double(int32_t)       )
      WITH_PRICE (_eosio_i64_to_f64,     double(int64_t)       )
      WITH_PRICE (_eosio_ui32_to_f64,    double(int32_t)       )
      WITH_PRICE (_eosio_ui64_to_f64,    double(int64_t)       )
);
