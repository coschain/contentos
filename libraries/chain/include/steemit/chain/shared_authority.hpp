...
FC_REFLECT_TYPENAME( contento::chain::shared_authority::account_authority_map)
FC_REFLECT( contento::chain::shared_authority, (weight_threshold)(account_auths)(key_auths) )
