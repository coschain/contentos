...
#include <contento/chain/multi_index_includes.hpp>
...
CHAINBASE_SET_INDEX_TYPE(contento::chain::table_id_object, contento::chain::table_id_multi_index)
CHAINBASE_SET_INDEX_TYPE(contento::chain::key_value_object, contento::chain::key_value_index)

CHAINBASE_SET_INDEX_TYPE(contento::chain::index64_object, contento::chain::index64_index)
CHAINBASE_SET_INDEX_TYPE(contento::chain::index128_object, contento::chain::index128_index)
CHAINBASE_SET_INDEX_TYPE(contento::chain::index256_object, contento::chain::index256_index)
