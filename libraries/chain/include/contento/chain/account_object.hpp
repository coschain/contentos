...
FC_REFLECT( contento::chain::account_object,
...
CHAINBASE_SET_INDEX_TYPE( contento::chain::account_authority_object, contento::chain::account_authority_index )

FC_REFLECT( contento::chain::vesting_delegation_object,
            (id)(delegator)(delegatee)(vesting_shares)(min_delegation_time) )
CHAINBASE_SET_INDEX_TYPE( contento::chain::vesting_delegation_object, contento::chain::vesting_delegation_index )

FC_REFLECT( contento::chain::vesting_delegation_expiration_object,
            (id)(delegator)(vesting_shares)(expiration) )
CHAINBASE_SET_INDEX_TYPE( contento::chain::vesting_delegation_expiration_object, contento::chain::vesting_delegation_expiration_index )

FC_REFLECT( contento::chain::owner_authority_history_object,
             (id)(account)(previous_owner_authority)(last_valid_time)
          )
CHAINBASE_SET_INDEX_TYPE( contento::chain::owner_authority_history_object, contento::chain::owner_authority_history_index )

FC_REFLECT( contento::chain::account_recovery_request_object,
             (id)(account_to_recover)(new_owner_authority)(expires)
          )
CHAINBASE_SET_INDEX_TYPE( contento::chain::account_recovery_request_object, contento::chain::account_recovery_request_index )

FC_REFLECT( contento::chain::change_recovery_account_request_object,
             (id)(account_to_recover)(recovery_account)(effective_on)
          )
CHAINBASE_SET_INDEX_TYPE( contento::chain::change_recovery_account_request_object, contento::chain::change_recovery_account_request_index )
