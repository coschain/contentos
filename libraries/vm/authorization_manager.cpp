...
#include <contento/chain/authority_checker.hpp>
...
namespace contento { namespace chain {
                                                                             ...
                                                                             )const
   {
      ...
      try {
         ...
         if( *linked_permission == config::contento_any_name )
            return optional<permission_name>();
                                                             ...
                                                             )const
   {
      ...
      if( *unlinked_permission_name == config::contento_any_name )
         return;
      ...
      for( const auto& act : actions ) {
         ...
         for( const auto& declared_auth : act.authorization ) {
            ...
            if( !special_case ) {
               ...
               if( min_permission_name ) { // since special cases were already handled, it should only be false if the permission is contento.any
