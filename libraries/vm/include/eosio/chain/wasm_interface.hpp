...
namespace contento { namespace chain {
   ...
   class wasm_interface {
      public:
         ...
         //validates code -- does a WASM validation pass and checks the wasm against contento specific constraints
      ...
      private:
         ...
         friend class contento::chain::webassembly::common::intrinsics_accessor;
   };
...
FC_REFLECT_ENUM( contento::chain::wasm_interface::vm_type, (wavm)(binaryen) )
