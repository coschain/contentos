...
namespace contento { namespace chain { namespace wasm_ops {
...
struct field_specific_params {
   ...
   static void pack(instruction_stream* stream, Field& f) { return contento::chain::wasm_ops::pack(stream, f); }
   static auto to_string(Field& f) { return std::string(" ")+
                                       contento::chain::wasm_ops::to_string(f); }
};
template <>
...
template <class Op_Types>
struct contento_OperatorDecoderStream
{
   contento_OperatorDecoderStream(const std::vector<U8>& codeBytes)
...
template <class Op_Types>
const std::vector<instr*>* contento_OperatorDecoderStream<Op_Types>::_cached_ops;

}}} // namespace contento, chain, wasm_ops

FC_REFLECT_TEMPLATE( (typename T), contento::chain::wasm_ops::block< T >, (code)(rt) )
FC_REFLECT( contento::chain::wasm_ops::memarg, (a)(o) )
FC_REFLECT( contento::chain::wasm_ops::blocktype, (result) )
FC_REFLECT( contento::chain::wasm_ops::memoryoptype, (end) )
