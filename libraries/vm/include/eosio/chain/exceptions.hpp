 ...
 * The main difference here is that if the exception caught isn't of type "contento::chain::chain_exception"
 * This macro will rethrow the exception as the specified "exception_type"
 */
#define EOS_RETHROW_EXCEPTIONS(exception_type, FORMAT, ... ) \
   catch (contento::chain::chain_exception& e) { \
...
namespace contento { namespace chain {
   ...
   FC_DECLARE_DERIVED_EXCEPTION( action_validate_exception, chain_exception,
      ...
      FC_DECLARE_DERIVED_EXCEPTION( contento_assert_message_exception, action_validate_exception,
                                    3050003, "contento_assert_message assertion failure" )
      FC_DECLARE_DERIVED_EXCEPTION( contento_assert_code_exception, action_validate_exception,
                                    3050004, "contento_assert_code assertion failure" )
