...
#include <contento/chain/resource_limits_private.hpp>
#include <contento/chain/transaction_metadata.hpp>
#include <contento/chain/transaction.hpp>
#include <algorithm>

namespace contento { namespace chain { namespace resource_limits {
...
} } } /// contento::chain::resource_limits
