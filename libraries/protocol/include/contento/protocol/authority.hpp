 ...
 * - Length is between (inclusive) CONTENTO_MIN_ACCOUNT_NAME_LENGTH and CONTENTO_MAX_ACCOUNT_NAME_LENGTH
 */
...
FC_REFLECT_TYPENAME( contento::protocol::authority::account_authority_map)
FC_REFLECT_TYPENAME( contento::protocol::authority::key_authority_map)
FC_REFLECT( contento::protocol::authority, (weight_threshold)(account_auths)(key_auths) )
FC_REFLECT_ENUM( contento::protocol::authority::classification, (owner)(active)(key)(posting) )
