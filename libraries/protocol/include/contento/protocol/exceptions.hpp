...
namespace contento { namespace protocol {
   ...
   FC_DECLARE_DERIVED_EXCEPTION( tx_missing_active_auth,            contento::protocol::transaction_exception, 3010000, "missing required active authority" )
   FC_DECLARE_DERIVED_EXCEPTION( tx_missing_owner_auth,             contento::protocol::transaction_exception, 3020000, "missing required owner authority" )
   FC_DECLARE_DERIVED_EXCEPTION( tx_missing_posting_auth,           contento::protocol::transaction_exception, 3030000, "missing required posting authority" )
