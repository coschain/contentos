#include "../../../chain/include/contento/chain/wasm_contento_constraints.hpp"
...
namespace WASM
{
	...
	void serializeFunctionBody(InputStream& sectionStream,Module& module,FunctionDef& functionDef)
	{
      ...
      constexpr size_t max_size = contento::chain::wasm_constraints::maximum_code_size;
	...
	void serializeImportSection(Stream& moduleStream,Module& module)
	{
		serializeSection(moduleStream,SectionType::import,[&module](Stream& sectionStream)
		{
         ...
         constexpr size_t max_size = contento::chain::wasm_constraints::maximum_section_elements;
			if(Stream::isInput)
			{
