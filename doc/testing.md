...
operation_tests      // Unit Tests of Contentos operations
operation_time_tests // Tests of Contentos operations that include a time based component (ex. vesting withdrawals)
...
```
cmake -D BUILD_CONTENTOS_TESTNET=ON -D ENABLE_COVERAGE_TESTING=true -D CMAKE_BUILD_TYPE=Debug .
make
