...
target_link_libraries( {plugin_provider}_{plugin_name} contento_app contento_chain contento_protocol )
...
{{
   public:
      {plugin_name}_api( const contento::app::api_context& ctx );
...
class {plugin_name}_plugin : public contento::app::plugin
{{
   public:
      {plugin_name}_plugin( contento::app::application* app );
...
{{
   public:
      {plugin_name}_api_impl( contento::app::application& _app );
...
{plugin_name}_api_impl::{plugin_name}_api_impl( contento::app::application& _app ) : app( _app )
{{}}
...
{plugin_name}_api::{plugin_name}_api( const contento::app::api_context& ctx )
{{
...
{{
   public:
      {plugin_name}_plugin_impl( contento::app::application& app );
...
{plugin_name}_plugin_impl::{plugin_name}_plugin_impl( contento::app::application& app )
  : _app(app) {{}}
...
{plugin_name}_plugin::{plugin_name}_plugin( contento::app::application* app )
   : plugin(app)
{{
