...
int main(int argc, char** argv) {
   ...
   try {
      ...
      std::cerr << "------------------------------------------------------\n";
      auto initminer_private_key = graphene::utilities::key_to_wif( CONTENTO_INIT_PRIVATE_KEY );
      std::cerr << "initminer public key: " << CONTENTO_INIT_PUBLIC_KEY_STR << "\n";
      std::cerr << "initminer private key: " << initminer_private_key << "\n";
      std::cerr << "chain id: " << std::string(CONTENTO_CHAIN_ID) << "\n";
      std::cerr << "blockchain version: " << fc::string( CONTENTO_BLOCKCHAIN_VERSION ) << "\n";
      std::cerr << "------------------------------------------------------\n";
#else
      std::cerr << "------------------------------------------------------\n\n";
