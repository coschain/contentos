...
def parse_arguments(src_default):
    ...
    parser = MyParser(description="Helper function to call cmake with appropriate configuration to build Contentos.")
    ...
    parser.add_argument("--src", dest="source_dir", metavar="SOURCEDIR", type=convert_to_dir, default=argparse.SUPPRESS, 
                        help="Contentos source directory (if omitted, will assume is at ../.. relative to location of this script)")
