...
#ifdef DISABLE_COSLIB_SERIALIZE
#include <cosiolib/serialize.hpp>
#undef COSLIB_SERIALIZE
#define COSLIB_SERIALIZE(...)
#endif
...
struct u128_action {
  ...
  COSLIB_SERIALIZE( u128_action, (values) )
};
...
struct cf_action {
   ...
   COSLIB_SERIALIZE( cf_action, (payload)(cfd_idx) )
};
...
struct dtt_action {
   ...
   COSLIB_SERIALIZE( dtt_action, (payer)(deferred_account)(deferred_action)(permission_name)(delay_sec) )
};
...
struct invalid_access_action {
   ...
   COSLIB_SERIALIZE( invalid_access_action, (code)(val)(index)(store) )
};
