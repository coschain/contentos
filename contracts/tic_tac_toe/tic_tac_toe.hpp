...
namespace tic_tac_toe {
   ...
   struct game {
      ...
      COSLIB_SERIALIZE( game, (challenger)(host)(turn)(winner)(board) )
   };
   ...
   struct create {
      ...
      COSLIB_SERIALIZE( create, (challenger)(host) )
   };
   ...
   struct restart {
      ...
      COSLIB_SERIALIZE( restart, (challenger)(host)(by) )
   };
   ...
   struct close {
      ...
      COSLIB_SERIALIZE( close, (challenger)(host) )
   };
   ...
   struct movement {
      ...
      COSLIB_SERIALIZE( movement, (row)(column) )
   };
   ...
   struct move {
      ...
      COSLIB_SERIALIZE( move, (challenger)(host)(by)(mvt) )
   };

   /**
    * @brief table definition, used to store existing games and their current state
    */
   typedef cosio::multi_index< games_account, game> games;
}
/// @}
