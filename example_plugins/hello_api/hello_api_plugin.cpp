...
namespace contento { namespace example_plugin {

class hello_api_plugin : public contento::app::plugin
{
   public:
      /**
       ...
       */
      hello_api_plugin( contento::app::application* app );
...
{
   public:
      hello_api_api( const contento::app::api_context& ctx );
...
FC_API( contento::example_plugin::hello_api_api,
   (get_message)
   )

namespace contento { namespace example_plugin {

hello_api_plugin::hello_api_plugin( contento::app::application* app ) : contento::app::plugin(app) {}
...
hello_api_api::hello_api_api( const contento::app::api_context& ctx ) : _app(ctx.app) {}
