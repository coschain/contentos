...
CS_ADDRESS_CROWDSALE               = "0xd0a6e6c54dbc68db5db3a091b171a77407ff7ccf"

const Web3 = require('web3'); var web3 = new Web3();
//web3.setProvider( new web3.providers.WebsocketProvider("ws://127.0.0.1:9000"));
web3.setProvider( new web3.providers.WebsocketProvider("wss://mainnet.infura.io/ws"));

console.log('111')
 var contract = new web3.eth.Contract(CROWDSALE_ABI,  CS_ADDRESS_CROWDSALE)
    contract.getPastEvents('LogBuy', { fromBlock : 3959116, toBlock : 3959215 }).then( buys => {
         if(buys.length){
             let request = []
             buys.forEach( buy => {
                     request.push({
                         ...
                         eth_amount:   buy.returnValues.amount
                     })
//                     console.log(buy)
                 console.log('=================================')               
                 console.log('blockNumber:'+buy.blockNumber)               
                 console.log('window:'+buy.returnValues.window)               
                 console.log('user:'+buy.returnValues.user.toLowerCase())               
                 console.log('eth:'+buy.returnValues.amount)               
                 console.log('=================================')               
             })
         } else {
             console.log('no data')
